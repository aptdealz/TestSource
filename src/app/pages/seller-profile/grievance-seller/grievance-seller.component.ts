...
@Component({
  selector: 'app-grievance-seller',
  templateUrl: './grievance-seller.component.html',
  styleUrls: ['./grievance-seller.component.scss'],
})
export class GrievanceSellerComponent implements OnInit, OnDestroy {
  requirements: any = [];
